...
Real agency copy, not lorem ipsum — see DESIGN.md § "Content" for what was rewritten and why. If asked to add more sections/services, keep the same voice (short, confident, no filler) and follow the existing services' shape: a title plus a 4-item bullet list.
